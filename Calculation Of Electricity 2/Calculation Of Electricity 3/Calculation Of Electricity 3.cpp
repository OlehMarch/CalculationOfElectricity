...
// Calculation Of Electricity 3.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCalculationOfElectricity3App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CCalculationOfElectricity3App

CCalculationOfElectricity3App::CCalculationOfElectricity3App()
{
...
// Единственный объект CCalculationOfElectricity3App

CCalculationOfElectricity3App theApp;


// инициализация CCalculationOfElectricity3App

BOOL CCalculationOfElectricity3App::InitInstance()
{
	...
	CCalculationOfElectricity3Dlg dlg;
	m_pMainWnd = &dlg;
