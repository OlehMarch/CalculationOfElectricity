...
// Calculation Of Electricity.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCalculationOfElectricityApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CCalculationOfElectricityApp

CCalculationOfElectricityApp::CCalculationOfElectricityApp()
{
...
// Единственный объект CCalculationOfElectricityApp

CCalculationOfElectricityApp theApp;


// инициализация CCalculationOfElectricityApp

BOOL CCalculationOfElectricityApp::InitInstance()
{
	...
	CCalculationOfElectricityDlg dlg;
	m_pMainWnd = &dlg;
